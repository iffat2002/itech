  ...
  return (
    <div className="relative h-[500px] lg:h-screen">
      ...
      >
        <div className="px-2">
          <TypeAnimation
            sequence={[{heroHeading}]}
            wrapper="span"
            speed={50}
            className="!text-white text-center text-4xl lg:text-6xl font-bold"
            repeat={Infinity}
          />
          <Description
            description={heroDescription}
            className={"my-3 !text-white text-center"}
          />
          <div className="text-center">
            <Button
              title="Best Business Consultant"
              className={"text-white mt-2 styled-button"}
            />
          </div>
        </div>
      </div>
